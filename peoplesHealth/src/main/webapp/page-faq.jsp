...
<head>
  <meta charset="utf-8">
  <title>Frequently Asked Questions | BMI</title>
              ...
              <div class="row">
                <div class="col-md-3 col-sm-3">
                  <ul class="tabbable faq-tabbable">
                    <li class="active"><a href="#tab_1" data-toggle="tab">View BMI</a></li>
                    <li><a href="#tab_2" data-toggle="tab">Update Weight and Height</a></li>
                    <li><a href="#tab_3" data-toggle="tab">Update Note to Self</a></li>
                  </ul>
                </div>
                            ...
                            <div class="panel panel-default">
                               ...
                               <div class="panel-collapse collapse in" id="accordion1_1">
                                  <div class="panel-body">
                                     BMI calculation will be shown here
                                  </div>
                               </div>
                            </div>
                      ...
                      <div class="tab-pane" id="tab_2">
                         <div class="panel-group" id="accordion2">
                            <div class="panel panel-default">
                               <div class="panel-heading">
                                  <h4 class="panel-title">
                                     <a href="#accordion2_1" data-parent="#accordion1" data-toggle="collapse" class="accordion-toggle">
                      ...
                      <div class="tab-pane" id="tab_3">
                         <div class="panel-group" id="accordion3">
                            <div class="panel panel-default">
                               <div class="panel-heading">
                                  <h4 class="panel-title">
                                     <a href="#accordion3_1" data-parent="#accordion1" data-toggle="collapse" class="accordion-toggle">
                                     Update Note to Self
                                     </a>
                                  </h4>
                               </div>
