...
<head>
  <meta charset="utf-8">
  <title>Services | Food and Activity</title>
              ...
              <div class="row">
                ...
                <div class="col-md-7 tab-style-1">
                  <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-1">Food Consumption</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-2">Activity</a></li>
                  </ul>
                  <div class="tab-content">
                    <div id="tab-1" class="tab-pane row fade active in">
                      <div class="col-md-9">
                        <p class="margin-bottom-10">Food consumption interface will be provided here</p>
                      </div>
                    </div>
